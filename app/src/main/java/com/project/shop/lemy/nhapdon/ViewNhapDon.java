...
import com.lemy.telpoo2lib.dialog.DialogSupport;
...
public class ViewNhapDon extends ViewNhapDonParent{
    ...
    public ViewNhapDon(FloatingViewService context){
        super(context);
...
//                           }
                    ...
                    case TaskType.SEARCH_PRODUCT_V2:
                        ...
                        try {
                            ...
                            simpleAdapter.setOnShowToast(msg1 -> {
                                showToast(msg1);
                            });
